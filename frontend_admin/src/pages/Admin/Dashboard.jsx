      ...
      <div className='flex flex-wrap gap-3'>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <button onClick={() => navigate("/doctor-list")} className='text-gray-400 hover:bg-gray-200'> Doctors</button>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          ...
          <div>
            ...
            <button onClick={() => navigate("/all-appointments")} className='text-gray-400 hover:bg-gray-200'> Appointments</button>
          </div>
        </div>
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
